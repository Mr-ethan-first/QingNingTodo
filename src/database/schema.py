...
DEFAULT_SETTINGS = [
    ...
    ("stats_show_wake", "1", "统计-显示唤醒"),
    ("stats_show_sleep", "1", "统计-显示睡眠"),
    ("stats_show_interrupt", "1", "统计-显示中断"),
    ("stats_trend_smooth", "1", "统计-趋势平滑"),
    ("stats_chart_unit", "minute", "统计-图表单位(minute/hour)"),
    ("stats_monthly_range", "month", "统计-月度范围(month/7days)"),
